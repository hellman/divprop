r"""
S-boxes collection ported from SageMath for using in pure python.
...
Midori_MC_slice = SBox([0, 14, 13, 3, 11, 5, 6, 8, 7, 9, 10, 4, 12, 2, 1, 15])
MANTIS = Midori_Sb0
CRAFT = Midori_Sb0
...
PRESENTMOD   = SBox([0x6, 0x7, 0xe, 0x3, 0x1, 0x0, 0x8, 0xd, 0x9, 0x4, 0xf, 0xa, 0xc, 0x5, 0xb, 0x2])
CiliPadi     = PRESENT
PHOTON   = PRESENT
ORANGE   = PHOTON
